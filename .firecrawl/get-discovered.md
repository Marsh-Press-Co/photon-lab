...
- [Overview](https://docs.cdp.coinbase.com/get-started/overview)
- [Initial Setup](https://docs.cdp.coinbase.com/get-started/initial-setup)
- Build with AI
...
- Custodial WalletsBeta

- Agentic Wallet

- [USDC Rewards](https://docs.cdp.coinbase.com/wallets/usdc-rewards)

### PAYMENTS

- [Overview](https://docs.cdp.coinbase.com/payments/overview)
- [Metadata](https://docs.cdp.coinbase.com/payments/metadata)
...
- x402
  ...
  - [Overview](https://docs.cdp.coinbase.com/x402/welcome)
  - [How x402 works](https://docs.cdp.coinbase.com/x402/how-it-works)
  - Seller



    - [Quickstart](https://docs.cdp.coinbase.com/x402/seller/quickstart)
    ...
    - [Production Configuration](https://docs.cdp.coinbase.com/x402/seller/production-configuration)
  - Buyer
...
- [Overview](https://docs.cdp.coinbase.com/onchain-tools/overview)
- Paymaster
...
- [Overview](https://docs.cdp.coinbase.com/customers-kyc/overview)
- [Quickstart](https://docs.cdp.coinbase.com/customers-kyc/quickstart)
- [Customers](https://docs.cdp.coinbase.com/customers-kyc/customers)
- [Capabilities](https://docs.cdp.coinbase.com/customers-kyc/capabilities)
- [Requirements](https://docs.cdp.coinbase.com/customers-kyc/requirements)
- [Webhooks](https://docs.cdp.coinbase.com/customers-kyc/webhooks)

### WEBHOOKS

- [Overview](https://docs.cdp.coinbase.com/webhooks/overview)
- [Quickstart](https://docs.cdp.coinbase.com/webhooks/quickstart)
- [Signature Verification](https://docs.cdp.coinbase.com/webhooks/verify-signatures)
- Event Types
...
- [Configure discovery with the CDP SDK](https://docs.cdp.coinbase.com/x402/seller/get-discovered#configure-discovery-with-the-cdp-sdk)
  - [Add richer discovery metadata](https://docs.cdp.coinbase.com/x402/seller/get-discovered#add-richer-discovery-metadata)
- [Validate your endpoint](https://docs.cdp.coinbase.com/x402/seller/get-discovered#validate-your-endpoint)
- [Get featured: curation tiers](https://docs.cdp.coinbase.com/x402/seller/get-discovered#get-featured-curation-tiers)
  - [Requirements for curation](https://docs.cdp.coinbase.com/x402/seller/get-discovered#requirements-for-curation)
  - [Staying curated](https://docs.cdp.coinbase.com/x402/seller/get-discovered#staying-curated)
- [Get discovered checklist](https://docs.cdp.coinbase.com/x402/seller/get-discovered#get-discovered-checklist)
- [Troubleshooting discovery](https://docs.cdp.coinbase.com/x402/seller/get-discovered#troubleshooting-discovery)
- [What to read next](https://docs.cdp.coinbase.com/x402/seller/get-discovered#what-to-read-next)
...
\\
Previous](https://docs.cdp.coinbase.com/x402/seller/quickstart) [Charge over MCP\\
\\
Next](https://docs.cdp.coinbase.com/x402/seller/mcp-payments)
